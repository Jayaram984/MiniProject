...
main = tkinter.Tk()
main.title("A MACHINE LEARNING BASED LIGHTWEIGHT INTRUSION DETECTION SYSTEM FOR IOT") 
...
font = ('times', 15, 'bold')
title = Label(main, text='A MACHINE LEARNING BASED LIGHTWEIGHT INTRUSION DETECTION SYSTEM FOR IOT')
...
adasynButton1 = Button(main, text="ADASYN Augmentation", command=augmentation, bg='#ffb3fe')
